#!/bin/bash
# Script to remove already committed assets from git tracking
...
echo "Asset files have been removed from git tracking."
echo "Now you can commit these changes with: git commit -m \"Remove asset files from git tracking\""
